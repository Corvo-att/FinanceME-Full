        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForecastMonth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProjectedIncome = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProjectedExpenses = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProjectedSavings = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ActualIncome = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ActualExpenses = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_AlertRules_AlertRuleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<int>(type: "int", nullable: true),
                    TransferToAccountId = table.Column<int>(type: "int", nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                    ...
                    RecurringSourceId = table.Column<int>(type: "int", nullable: true),
                    IsAutoCategorized = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlertRules_UserId_IsEnabled",
                table: "AlertRules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Forecasts_UserId_ForecastMonth",
                table: "Forecasts",
                columns: new[] { "UserId", "ForecastMonth" },
                unique: true);
